...
urlpatterns = [
    ...
    path('mobile/auth/otp/register/request', views.MobileOTPRegisterRequestView.as_view(), name='mobile_otp_register_request'),
    path('mobile/auth/otp/register/verify', views.MobileOTPRegisterVerifyView.as_view(), name='mobile_otp_register_verify'),
