...
MOBILE_OTP_TEST_CODE = os.environ.get("MOBILE_OTP_TEST_CODE", "1111")
MOBILE_OTP_EXPIRE_MINUTES = int(os.environ.get("MOBILE_OTP_EXPIRE_MINUTES", 5))
SMS_PROVIDER_LOGIN = os.environ.get("SMS_PROVIDER_LOGIN", "")
